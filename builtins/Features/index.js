...
export default (function () {
  return /*#__PURE__*/_jsx(Features, {
    items: [{
      title: '现代化主题风格',
      image: '💠',
      description: '基于近年流行的风格趋势研究，本主题包采用了流动色、毛玻璃、光影质感、自然动效等现代化的设计表现手法，将界面以更加简约、美观的方式呈现，使得文档更加直观、易读、易用'
    }, {
      title: '亮暗色主题模式一键切换',
      link: '/guide/theme',
      ...
      title: '精美的语法高亮',
      description: '本主题包提供准确、精美的语法高亮特性。底层采用了现代化的语法高亮库 Shiki 与 Prism，并提供了丰富的代码高亮方案，帮助用户更好地阅读代码',
